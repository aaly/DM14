...
namespace DM14
{
	...
	namespace types
	{
		...
		int intSymbols()
		{
			keywords = {"with", "use", "while", "for", "case", "if", "class", "else", "break", "continue", "return", "distribute", "reset", "addparent",
				"struct", "setnode", "backprop", "channel", "nodist", "noblock", "recurrent", "extern", "endextern", "link", "slink", "global", "thread"};

			Operators = {make_pair("\\",GENERALOPERATOR),  
									make_pair(">",BINOPERATOR),
									make_pair(">>",BINOPERATOR),
									make_pair("<",BINOPERATOR),
									make_pair("<<",BINOPERATOR),
									make_pair("<-",GENERALOPERATOR),
									make_pair("->",BINOPERATOR),
									make_pair(".",BINOPERATOR),
									make_pair("?",GENERALOPERATOR),
									make_pair("~",GENERALOPERATOR),
