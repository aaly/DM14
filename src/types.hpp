...
// static multimap<int, int>			typeOperator; // holds type and
// its allowed binay operators static multimap<int, int>
// typeValue; // holds type and its allowed Types to operate wuth
...
enum CLASSIFIER { PUBLIC = 0, PRIVATE, PROTECTED };
