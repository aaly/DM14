...
int Socket::setLocalAddressAndPort(const string &localAddress,
  ...
  int res =
      ::bind(sockDesc, (struct sockaddr *)(&localAddr), sizeof(sockaddr_in));
  if (res < 0) {
...
cout << "in buffer : " <<  value << endl;
  ...
  // cout << "recvv : " << recieved << " : " << recieved.size() << " : " << rtn
  // << endl << flush;
...
TCPSocket::TCPSocket(const string &localAddress, unsigned short localPort,
