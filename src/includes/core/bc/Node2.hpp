...
class Node
{
	public:
		...
		template<class T> void need(unsigned int var, int index, bool pointer, int node, T* variable, bool block);
...
template<class T> void Node::need(unsigned int var, int index, bool pointer, int node, T* variable, bool block)
{
