...
Time::Time(int year, int month, int day, int hour, int minute, int second=0, bool useLocalTime=true)
{
...
string Time::toString (bool includeDate, bool includeTime, bool includeSeconds=true, bool use24HourClock=false)
{
	string format;
...
int Time::Substract(Time& t)
{
	return difftime(timeT, t.getInternalTime());
};
