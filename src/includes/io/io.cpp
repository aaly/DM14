...
{
	// check for ?VARNAME? , if true , then cout << original string till '?' << VARNAME << rest of string ... ;
...
int	dm14license()
{
	...
	cout	<< " Copyright (c) 2017, <Abdallah Aly> <aaly90 [@] gmail.com>" 						<< endl
			...
			<< "* Redistributions of source code must retain the above copyright"					<< endl
			<< "notice, this list of conditions and the following disclaimer."						<< endl
			<< "* Redistributions in binary form must reproduce the above copyright"				<< endl
			<< "notice, this list of conditions and the following disclaimer in the"				<< endl
			<< "documentation and/or other materials provided with the distribution."				<< endl
			<< "* Neither the name of the <organization> nor the"									<< endl
			<< "names of its contributors may be used to endorse or promote products"				<< endl
			<< "derived from this software without specific prior written permission."				<< endl
			...
			<< "DISCLAIMED. IN NO EVENT SHALL <COPYRIGHT HOLDER> BE LIABLE FOR ANY"					<< endl
			<< "DIRECT, INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES"			<< endl
			<< "(INCLUDING, BUT NOT LIMITED TO, PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES;"		<< endl
			<< "LOSS OF USE, DATA, OR PROFITS; OR BUSINESS INTERRUPTION) HOWEVER CAUSED AND"		<< endl
			<< "ON ANY THEORY OF LIABILITY, WHETHER IN CONTRACT, STRICT LIABILITY, OR TORT"			<< endl
			<< "(INCLUDING NEGLIGENCE OR OTHERWISE) ARISING IN ANY WAY OUT OF THE USE OF THIS"		<< endl
